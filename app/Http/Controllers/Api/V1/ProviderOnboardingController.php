...
class ProviderOnboardingController extends Controller
{
    ...
    public function status(Request $request)
    {
        ...
        return $this->ok([
            ...
            'provider' => [
                ...
                'interview_required' => (bool) ($provider->interview_required ?? false),
                'interview_status' => (string) ($provider->interview_status ?? ''),
                'approval_note' => $provider->approval_note ?: null,
    ...
    public function submit(Request $request, ProviderOnboardingNotifier $notifier)
    {
        ...
        return $this->ok([
            ...
            'approval_status' => (string) ($provider->approval_status ?? 'pending'),
            'onboarding_completed_at' => optional($provider->onboarding_completed_at)->toIso8601String(),
        ], 'Tumepokea taarifa zako. Ziko kwenye uhakiki.');
    }
